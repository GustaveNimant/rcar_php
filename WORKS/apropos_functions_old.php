...
function apropos_content_by_block_name_array_build () {
  ...
  if (array_is_empty_of_array ($nam_blo_a)) {
    ...
    foreach ($nam_blo_a as $nam_blo) {
      ...
      $con_ite = file_content_read_of_fullnameoffile ($fno_txt);
...
function apropos_display_item_html_make_of_entry_name_of_item_name_of_item_content_of_item_name_array_of_language ($nam_ent, $nam_blo, $con_ite, $nam_blo_a, $lan) {
  ...
  $html_str .= '</td><td> ';
  $html_str .= button_submit_item_remove_of_entry_name_of_item_name_of_item_name_array ($nam_ent, $nam_blo, $nam_blo_a);
...
function apropos_display_section_build (){
  ...
  $en_txt = ''; /* Improve */
  /* $en_str_a = array ('properties', 'entry_current_name'); */
  /* # debug_n_check ($here , "en_str_a", $en_str_a); */

  /* include "bubble_en_text_by_key_hash_library.php"; */
...
function apropos_create_input_submit_html_build () {
  ...
  $nam_ent = irp_provide ('entry_current_name', $here);
  debug_n_check ($here, 'entry_current_name', $nam_ent);
  ...
  $html_str .= 'method="get"> ' .  "\n"; 
  $html_str .= '<input type="hidden" name="entry_current_name" value="' . $nam_ent . '" /> ';
  $html_str .= '<center> ' . "\n";
...
*/
  ...
  /* Improve Get */
  $html_str .= '<a href="' . $script_action .  '?entry_current_name=Introduction" title="';
  $html_str .= $abo;
  $html_str .= '"> ';
