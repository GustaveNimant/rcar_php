...
function item_next_create_form_new_create_content_title_build (){
  $here = __FUNCTION__;
...
function item_next_create_form_new_create_content_textarea_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_next_create_form_new_create_content_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = comment_entering_of_function_name ($here);
  $html_str .= irp_provide ('item_next_create_form_new_create_content_title', $here);
  $html_str .= irp_provide ('item_next_create_form_new_create_content_textarea', $here);
  $html_str .= comment_exiting_of_function_name ($here);
