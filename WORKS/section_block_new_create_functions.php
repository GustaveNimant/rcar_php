...
function section_block_new_create_title_n_action_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function section_block_new_create_build () {
  ...
  $html = irp_provide ('section_block_new_create_title_n_action', $here);

  $html_str  = comment_entering_of_function_name ($here);
  $html_str .= common_html_span_background_color_of_html ($html);
  $html_str .= comment_exiting_of_function_name ($here);
