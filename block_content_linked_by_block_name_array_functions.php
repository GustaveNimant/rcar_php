...
$module = "block_content_linked_by_block_name_array_functions";

$Documentation[$module]['purpose'] = "to set href links for each word of an block content being an entry_surname";
...
$Documentation[$module]['word_cleaned'] = "a word of the original block content string after filtering, removing accents and capitalize. Similar to entry_name";
...
function block_content_linked_by_block_name_array_build () {
  $here = __FUNCTION__;
  ...
  foreach ($con_by_nam_ite_a as $nam_ite => $con_ite) {
      $wor_lin_by_nam_ite_a [$nam_ite] = replace_all_sub_sentence_by_links_of_surname_by_name_array_of_entry_name_array_of_block_content_of_surname_lowercase_array ($sur_by_nam_a, $nam_ent_a, $con_ite, $sur_low_a);
  }
