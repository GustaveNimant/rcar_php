...
function block_current_name_ordered_array_build () {
  $here = __FUNCTION__;
  ...
  if (! has_values_unique_of_any_array ($nam_blo_cur_ord_a)) {
      ...
      $la_mes =  $la_mes_1 . ' ' . 'block_current_name_ordered_array' . ' ' . $la_mes_2;
  ...
  check_is_array_unique_of_what_of_array ('block_current_name_ordered_array', $nam_blo_cur_ord_a);
