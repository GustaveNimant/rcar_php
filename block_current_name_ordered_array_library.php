...
function block_current_name_ordered_array_update_after_block_rename ($nam_ent, $old_nam_blo, $new_nam_blo, $old_nam_blo_a) {
  $here = __FUNCTION__;
...
function block_current_name_ordered_array_update_after_block_create ($nam_ent, $nam_blo, $nam_blo_a) {
  $here = __FUNCTION__;
  entering_in_function ($here);
