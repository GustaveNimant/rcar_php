...
require_once "block_list_neworder_save_functions.php";

$module = "block_list_neworder_save";
...
/* irp_path_clean_register_of_top_key_of_bottom_key ($module, 'block_sequence_string'); */
