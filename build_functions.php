...
require_once "block_new_create_content_titlehelped_functions.php";
...
require_once "block_new_create_surname_titlehelped_functions.php";
...
require_once "entry_create_page_functions.php";
require_once "entry_create_page_titlehelped_functions.php";
require_once "entry_create_page_form_functions.php";

require_once "entry_display_functions.php";
require_once "entry_list_page_functions.php";
require_once "entry_list_select_display_section_functions.php";
require_once "entry_list_select_rename_section_functions.php";
require_once "entry_list_select_rename_titlehelped_functions.php";
require_once "entry_list_select_titlehelped_functions.php";
require_once "entry_name_array_functions.php";
require_once "entry_name_functions.php";
require_once "entry_newsurname_functions.php";
...
require_once "item_new_create_content_form_titlehelped_functions.php";
...
require_once "item_new_create_justification_titlehelped_functions.php";
