...
function session_debug_array_write () {
  ...
  $deb_a = irp_provide ('session_debug_array', $here);

  if (is_empty_of_array ($deb_a)){
...
function session_debug_array_build () {
  $here = __FUNCTION__;
