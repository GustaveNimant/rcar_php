...
entering_in_script ($entity . '_script');
...
$nam_ent_cur = irp_data_value_retrieve_and_store_of_get_key_of_script_name_of_where ($get_key, $script, $script);

$html_str = irp_provide ($entity, $entity . '_script');

print $html_str;

exiting_from_script ($entity . '_script');
