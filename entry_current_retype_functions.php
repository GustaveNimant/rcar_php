...
function entry_current_retype_page_title_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);

  $sur_ent_cur = irp_provide ('entry_current_surname_from_entry_current_name', $here);

  $en_tit = 'page for retyping the entry';
...
function entry_current_retype_link_to_return_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function entry_current_retype_build () {
  ...
  $html_str .= irp_provide ('entry_current_retype_page_title', $here);
  $html_str .= '<br><br>' . "\n";
