...
$module = "entry_text_create_functions";
# entering_in_module ($module);

function entry_text_create_message_of_entry_name_build () {
  $here = __FUNCTION__;
...
/* associated text */
  ...
  if (! file_exists ($fnd_txt)) {
      entry_subdirectory_create_of_subdirectory_name ($fnd_txt);
  }
...
function entry_create_update_of_surname_by_name_array_of_entry_newsurname_of_language ($sur_by_nam_a, $new_sur_ent, $lan) {
    $here = __FUNCTION__;
...
function entry_create_build () {
  ...
  $html_str .= entry_create_update_of_surname_by_name_array_of_entry_newsurname_of_language ($sur_by_nam_a, $new_sur_ent, $lan);
