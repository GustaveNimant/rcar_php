...
function arce_home_text_fr_accent_hash () {
    ...
    $fr_tex_h = array (
        ...
        'Règles de rédaction' => "permet d'accéder à l'entrée homonyme",
        'Faq' => "permet d'accéder à l'entrée homonyme",
        'Règles des propriétés' => "permet d'accéder à l'entrée homonyme",
