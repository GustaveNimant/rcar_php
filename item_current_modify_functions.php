...
$module = "item_current_modify_functions";
# entering_in_module ($module);

/* First Section Page Title */

function item_current_modify_section_page_title_build (){
  $here = __FUNCTION__;
  ...
  if ($kin_ite == 'question') {
      ...
      $en_tit = 'modify the content of the ' . $kin_ite;  
  }
...
function item_current_modify_section_content_old_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_current_modify_section_content_old_display_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_current_modify_section_content_old_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_current_modify_section_content_old_title', $here);
  $html_str .= irp_provide ('item_current_modify_section_content_old_display', $here);
  debug_n_check ($here , '$html_str',  $html_str);
  exiting_from_function ($here);
...
function item_current_modify_section_content_new_create_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_current_modify_section_content_new_create_textarea_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $con_ite_new = irp_provide ('item_current_content', $here);
  debug_n_check ($here , '$con_ite_new', $con_ite_new);

  $html_str  = '';
  $html_str .= '<textarea name="item_current_content_modified" rows="2" cols="100" />';
...
function item_current_modify_section_content_new_create_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_current_modify_section_content_new_create_title', $here);
  $html_str .= irp_provide ('item_current_modify_section_content_new_create_textarea', $here);
...
function item_current_modify_section_justify_new_create_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_current_modify_section_justify_new_create_textarea_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_current_modify_section_justify_new_create_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_current_modify_section_justify_new_create_title', $here);
  $html_str .= irp_provide ('item_current_modify_section_justify_new_create_textarea', $here);
...
function item_current_modify_build () {
  ...
  $html_str .= irp_provide ('item_current_modify_section_page_title', $here);

  $html_str .= '<form action="' . $script_action. '" method="get"> ' . "\n";
  $html_str .= '<input type="hidden" name="item_current_action" value="modify" /> ';
  $html_str .= '<br> ';
  $html_str .= irp_provide ('item_current_modify_section_content_old', $here);
  $html_str .= '<br><br> ';
  $html_str .= irp_provide ('item_current_modify_section_content_new_create', $here);
  $html_str .= '<br><br> ';
  $html_str .= irp_provide ('item_current_modify_section_justify_new_create', $here);
  $html_str .= '<br><br> ';
