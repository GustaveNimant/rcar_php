...
$module = "item_delete_save_functions";
# entering_in_module ($module);

/* First Section Page Title */

function item_delete_save_section_page_title_build (){
  $here = __FUNCTION__;
...
function item_delete_save_catalog_actualize_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
  ...
  $con = item_name_catalog_delete_of_entry_name_of_item_name_catalog_of_item_name ($nam_ent, $cat_ite, $nam_ite);
  $ext_lis = irp_provide ('block_name_catalog_filename_extension', $here);
  $nof = "Item_name_catalog." . $ext_lis;
...
function item_delete_save_delete_file_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);
  ...
  $cmd_del  = 'cd ' . $dir . ';';
  $cmd_del .= 'rm ' . $nam_ite . '.' . $ext_txt . ' ' . $nam_ite . '.' . $ext_jus;
...
function item_delete_save_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);
  ...
  $lan = $_SESSION['parameters']['language'];
  $jus_ite = irp_provide ('item_delete_justification', $here);
  ...
  $html_log .= '<br> ';
  $html_log .= irp_provide ('item_delete_save_catalog_actualize', $here);
  $html_str .= irp_provide ('item_delete_save_section_page_title', $here);
  $html_str .= '<br><br> ';
  $html_log .= '<br><br> ';
  $html_log .= irp_provide ('item_delete_save_delete_file', $here);
