...
$module = "item_history_functions";
# entering_in_module ($module);

/* First Section Page Title */

function item_history_section_page_title_build (){
  $here = __FUNCTION__;
...
function item_history_section_since_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_history_section_since_inputtype_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_history_section_since_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_history_section_since_title', $here);
  $html_str .= irp_provide ('item_history_section_since_inputtype', $here);
...
function item_history_section_before_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_history_section_before_textarea_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_history_section_before_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_history_section_before_title', $here);
  $html_str .= irp_provide ('item_history_section_before_textarea', $here);
...
function item_history_build () {
  ...
  $script_action = 'item_history_save.php';

  $html_str  = '';
  $html_str .= irp_provide ('pervasive_html_initial_section', $here);
  $html_str .= '<form action="' . $script_action. '" method="get"> ' . "\n";
  $html_str .= irp_provide ('item_history_section_page_title', $here);
  $html_str .= '<br><br> ';
  $html_str .= irp_provide ('item_history_section_since', $here);
  $html_str .= '<br><br><br> ';
  $html_str .= irp_provide ('item_history_section_before', $here);
  $html_str .= '<br><br> ';
