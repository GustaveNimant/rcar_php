...
require_once "item_list_neworder_save_functions.php";

$module = "item_list_neworder_save";
...
/* irp_path_clean_register_of_top_key_of_bottom_key ($module, 'item_sequence_string'); */
