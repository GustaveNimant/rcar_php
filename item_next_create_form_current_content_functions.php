...
function item_next_create_form_current_content_title_build (){
  $here = __FUNCTION__;
...
function item_next_create_form_current_content_display_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_next_create_form_current_content_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = '';
  $html_str .= irp_provide ('item_next_create_form_current_content_title', $here);
  $html_str .= irp_provide ('item_next_create_form_current_content_display', $here);
  debug_n_check ($here , '$html_str',  $html_str);
  exiting_from_function ($here);
