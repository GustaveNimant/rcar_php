...
function item_next_create_form_justification_title_n_help_build (){
  $here = __FUNCTION__;
...
function item_next_create_form_justification_textarea_title_build (){
  $here = __FUNCTION__;
  entering_in_function ($here);
...
function item_next_create_form_justification_textarea_build (){
    $here = __FUNCTION__;
    entering_in_function ($here);
...
function item_next_create_form_build () {
  ...
  $html_str .= irp_provide ('item_next_create_form_justification_title_n_help', $here);
  $html_str .= '<br>';
  ...
  $html_str .= '<br>';
  $html_str .= irp_provide ('item_next_create_form_justification_textarea_title', $here);
  $html_str .= '<br>';
  $html_str .= irp_provide ('item_next_create_form_justification_textarea', $here);
  $html_str .= '<br>';
