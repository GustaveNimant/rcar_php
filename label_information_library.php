...
/* Pure labels */
  ...
  case 'command' :
      $label_information = 
          array (
              ...
              'url_relative' => 'command_script.php',
  ...
  case 'entries' :
      $label_information = 
          array (
              'label_kind' => 'href',
              'url_relative' => 'entry_list_display_script.php',
              'block_kind' => 'undefined',
  ...
  case 'apropos' :
      $label_information = 
          array (
              ...
              'block_kind' => 'undefined',
              'kind_justification' => 'justification',
              'url_relative' => 'apropos_script.php',
  ...
  case 'language' :
      $label_information = 
          array (
              ...
              'block_kind' => 'undefined',
              'kind_justification' => 'justification',
              'url_relative' => 'language_select_script.php',
