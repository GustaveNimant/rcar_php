...
function language_select_html_make_of_language ($lan) {
  $here = __FUNCTION__;
...
function language_href_html_make_of_language ($lan) {
  ...
  $script_action = 'entry_list_display_script.php';
...
function language_select_section_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);


  $html_str  = comment_entering_of_function_name ($here);
  $html_str .= language_select_html_make_of_language ($lan);
  $html_str .= comment_exiting_of_function_name ($here);
...
function language_select_build () {
  $here = __FUNCTION__;
  entering_in_function ($here);

  $html_str  = comment_entering_of_function_name ($here);
  $html_str .= irp_provide ('pervasive_page_header', $here);
  $html_str .= irp_provide ('language_select_section', $here);
