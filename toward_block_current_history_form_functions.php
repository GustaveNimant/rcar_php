...
function toward_block_current_history_form_title_build () {
    $here = __FUNCTION__;
...
function toward_block_current_history_form_build () { 
  $here = __FUNCTION__;
  entering_in_function ($here);
  ...
  $html_str .= irp_provide ('toward_block_current_history_form_title', $here);
